            ...
            <div class="logo-menu-sec">
                <div class="container">
                    ...
                    <nav>
                        <div class="menu-sec">
                            <li>
                                <a class="menu-item-has-children"><a href="#" title="HOMEPAGES" itemprop="url"><span class="red-clr">FOOD ORDERING</span>HOMEPAGES</a>
                ...
                <div class="page-title-wrapper text-center">
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <div class="page-title-inner">
                            <h1 itemprop="headline">Register Reservation</h1>
                                                ...
                                                <ul class="nav nav-tabs brd-rd5">
                                                    ...
                                                    <li>
														<a href="#reservation-tab2" data-toggle="tab">
															<span class="brd-rd50">2</span> Select Package
														</a>
													</li>
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div class="tab-pane fade" id="reservation-tab2">
                                                        <div class="select-package-wrapper">
                                                            ...
                                                            <div class="step-buttons">
                                                                <a class="brd-rd3" href="#" title="" itemprop="url">Back Step</a>
                                                                <a class="brd-rd3 red-bg" href="#" title="" itemprop="url">Next Step</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <form class="restaurant-info-form brd-rd5">
                                                            <div class="row mrg20">
                                                                ...
                                                                <div class="col-md-12 col-sm-12 col-lg-12">
                                                                    ...
                                                                    <textarea class="brd-rd3"></textarea>
                                                                </div>
                                                                <div class="col-md-12 col-sm-12 col-lg-12">
                                                                    <div class="step-buttons">
                                                                        <a class="brd-rd3" href="#" title="" itemprop="url">Back Step</a>
