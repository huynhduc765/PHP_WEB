                     ...
                     <div class="container-fluid right_color">
                            ...
                            <div class="contain-section">
                                   <div class="contain-inner-section">
                                        ...
                                        <a href="edit.php?id_khachhang=<?php echo $item['TenTaiKhoan'] ?>" class="btn btn-primary float-button-right"><i class="fa fa-cogs"></i></a>

                                        <a href="Detel.php?id_khachhang=<?php echo $item['TenTaiKhoan'] ?>" class="btn btn-primary float-button-right"><i class="fa fa-trash-o"></i></a>
