                                                 ...
                                                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        ...
                                                        <div class="section-body">
                                                               ...
                                                               <table class="display datatable-default">
                                                                      ...
                                                                      ?>
                                                                             <tr>
                                                                             <td><?php echo $item['MaQuanAn'] ?></td>
                                                                                    <td><?php echo $item['TenQuanAn'] ?></td>
                                                                                    <td><?php echo $item['ChuSoHuu'] ?></td>
                                                                                    <td><?php echo $item['SoDienThoai'] ?></td>
                                                                                    <td><img  width="30px" height="50px" src="../../assets/images/resource/<?php echo $item['AvatarQuan'];?>"/></td>                                                                                   

                                                                                    <td>
                                                                                    <div class="btn-group float-xs-left" >

                                        <a href="edit.php?id_khachhang=<?php echo $row_dssp['id_khachhang'] ?>" class="btn btn-primary float-button-right"><i class="fa fa-cogs"></i></a>

                                        <a href="Detel.php?id_khachhang=<?php echo $row_dssp['id_khachhang'] ?>" class="btn btn-primary float-button-right"><i class="fa fa-trash-o"></i></a>
