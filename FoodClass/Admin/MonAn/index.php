                     ...
                     <div class="container-fluid right_color">
                            ...
                            <div class="contain-section">
                                   <div class="contain-inner-section">
                                                               ...
                                                               <table class="display datatable-default">
                                                                      ...
                                                                      ?>
                                                                             <tr>
                                                                                    ...
                                                                                    <td><img  width="30px" height="200px" src="../../assets/images/resource/<?php echo $item['Avatar'];?>"/></td>       
                                                                                    <td><?php echo $item['GioiThieuMonAn'] ?></td>
                                        ...
                                        <a href="Edit.php?MaMonAn=<?php echo $item['MaMonAn'] ?>" class="btn btn-primary float-button-right"><i class="fa fa-cogs"></i></a>

                                        <a href="Detel.php?MaMonAn=<?php echo $item['MaMonAn'] ?>" class="btn btn-primary float-button-right"><i class="fa fa-trash-o"></i></a>
