                ...
                <div class="page-title-wrapper text-center">
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <div class="page-title-inner">
                            <h1 itemprop="headline">Search Not Found</h1>
                                    ...
                                    <div class="row">
                                        <div class="col-md-9 col-sm-12 col-lg-9">
                                            <div class="search-found">
                                                <h3 itemprop="headline">Search Result Found <span class="red-clr">"Food"</span></h3>
                                                <p itemprop="description">Vivam pulput vehic Mauris porttitor erovel sapien Sed ut persp voluptatem accusanti...</p>
