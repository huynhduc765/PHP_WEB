        ...
        <form class="sign-form">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-lg-12">
                    <input class="brd-rd3" type="text" placeholder="Username" name="Ten">
                </div>
                <div class="col-md-12 col-sm-12 col-lg-12">
                    <input class="brd-rd3" type="password" placeholder="Password" name="Pass">
                </div>
                <div class="col-md-12 col-sm-12 col-lg-12">
                    <button class="red-bg brd-rd3" name="DangNhap" type="submit">LOG IN</button>
                </div>
                <div class="col-md-12 col-sm-12 col-lg-12">
