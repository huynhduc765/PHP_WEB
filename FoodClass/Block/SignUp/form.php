...
<div class="sign-popup text-center">
            <div class="sign-popup-wrapper brd-rd5">
                <div class="sign-popup-inner brd-rd5">
                    ...
                    <form class="sign-form" action="InsertUser.php" method="post">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-lg-12">
                                <input class="brd-rd3" name="username" id="username" type="text" placeholder="Username">
                            </div>
                        
                            <div class="col-md-12 col-sm-12 col-lg-12">
                                <input class="brd-rd3" name="password" id="password" type="password" placeholder="Password">
                            </div>
                            <div class="col-md-12 col-sm-12 col-lg-12">
                                <input class="brd-rd3" name="email" id="email" type="email" placeholder="Email">
                            </div>
                            <div class="col-md-12 col-sm-12 col-lg-12">
